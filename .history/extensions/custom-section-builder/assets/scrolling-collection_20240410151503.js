document.addEventListener('DOMContentLoaded', function() {
    ...
    const scrollSpeedSetting = parseInt(document.querySelector('.adedayo-scrolling-collection-grid').dataset.scrollSpeed, 10) || 2; // Ensuring a default value if not set
    const scrollStep = Math.max(1, scrollSpeedSetting); // Directly using the scrollSpeedSetting for scrollStep calculation
